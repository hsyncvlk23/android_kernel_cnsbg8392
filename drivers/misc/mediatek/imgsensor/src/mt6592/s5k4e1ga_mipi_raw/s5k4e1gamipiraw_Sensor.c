...
MSDK_SCENARIO_ID_ENUM S5K4E1GACurrentScenarioId = MSDK_SCENARIO_ID_CAMERA_PREVIEW;
...
void S5K4E1GA_write_cmos_sensor(kal_uint32 addr, kal_uint32 para)
{

	//char puSendCmd[4] = {(char)(addr >> 8) , (char)(addr & 0xFF) ,(char)(para >> 8),(char)(para & 0xFF)};
	iWriteReg((u16) addr , (u32) para , 1, S5K4E1GAMIPI_WRITE_ID);
...
static void S5K4E1GAPreviewSetting(void)
{
	...
	S5K4E1GA_write_cmos_sensor(0x30F5,0x08);//\D7迹ƥ\C5\E4
