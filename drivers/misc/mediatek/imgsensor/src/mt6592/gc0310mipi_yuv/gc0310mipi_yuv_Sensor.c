...
*
*************************************************************************/
void GC0310MIPI_gamma_select(kal_uint32 GammaLvl)
{
	switch(GammaLvl)
	{
 ...
 *
 *************************************************************************/
kal_uint16 GC0310MIPI_set_gain(kal_uint16 iGain)
{
	return iGain;
}
 ...
 *
 *************************************************************************/
void GC0310MIPI_night_mode(kal_bool bEnable)
{
	if (bEnable)
	{	
		// do nothing
...
void GC0310MIPI_sensor_init(void)
{
	...
	GC0310MIPI_write_cmos_sensor(0x02,0x00); //CLK and Data Diff Voltage   
	...
	GC0310MIPI_write_cmos_sensor(0x32,0x08); 
	...
	GC0310MIPI_write_cmos_sensor(0x41,0x25); 
	GC0310MIPI_write_cmos_sensor(0x42,0xdf); 
	GC0310MIPI_write_cmos_sensor(0x44,0x02); // 02 yuv 
	...
	///////////////////   DNDD  /////////////////////
	///////////////////////////////////////////////// 
	GC0310MIPI_write_cmos_sensor(0x80,0x00);
	GC0310MIPI_write_cmos_sensor(0x82,0x0b); 
	GC0310MIPI_write_cmos_sensor(0x83,0x20);
	GC0310MIPI_write_cmos_sensor(0x86,0x30); 
	GC0310MIPI_write_cmos_sensor(0x87,0x20);
	GC0310MIPI_write_cmos_sensor(0x88,0x10); 
	GC0310MIPI_write_cmos_sensor(0x89,0x20);
	...
	GC0310MIPI_write_cmos_sensor(0x90,0x88); 
	GC0310MIPI_write_cmos_sensor(0x91,0x10); 
	GC0310MIPI_write_cmos_sensor(0x92,0xf8); 
	GC0310MIPI_write_cmos_sensor(0x93,0x0a); 
	GC0310MIPI_write_cmos_sensor(0x94,0x8a);
	...
	GC0310MIPI_write_cmos_sensor(0xa2,0x33);
	GC0310MIPI_write_cmos_sensor(0xa4,0x30);
	GC0310MIPI_write_cmos_sensor(0xa5,0x20);
	GC0310MIPI_write_cmos_sensor(0xaa,0x50);
	GC0310MIPI_write_cmos_sensor(0xac,0x55);
	GC0310MIPI_write_cmos_sensor(0xb3,0x08);
	GC0310MIPI_write_cmos_sensor(0xb4,0x10);
	/////////////////////////////////////////////////
	///////////////////   GAMMA   ///////////////////
	/////////////////////////////////////////////////
	GC0310MIPI_write_cmos_sensor(0xbf,0x08); 
	...
	GC0310MIPI_write_cmos_sensor(0xd1,0x2a); 
	GC0310MIPI_write_cmos_sensor(0xd2,0x2a); 
	GC0310MIPI_write_cmos_sensor(0xd3,0x46); 
	...
	GC0310MIPI_write_cmos_sensor(0x0c,0x70); 
	...
	GC0310MIPI_write_cmos_sensor(0x1f,0x40);
	GC0310MIPI_write_cmos_sensor(0x20,0xa0); 
	...
	GC0310MIPI_write_cmos_sensor(0x92,0xf0); 
	GC0310MIPI_write_cmos_sensor(0x93,0xca);
	GC0310MIPI_write_cmos_sensor(0x95,0x1a); 
	GC0310MIPI_write_cmos_sensor(0x96,0xf0);
	GC0310MIPI_write_cmos_sensor(0x97,0x43); 
	GC0310MIPI_write_cmos_sensor(0x98,0x1a);
	GC0310MIPI_write_cmos_sensor(0x9a,0x43);
	GC0310MIPI_write_cmos_sensor(0x9b,0x1a); 
	...
	GC0310MIPI_write_cmos_sensor(0xa4,0xb8); 
	GC0310MIPI_write_cmos_sensor(0xa5,0xa0); 
	GC0310MIPI_write_cmos_sensor(0xa6,0xbd); 
	GC0310MIPI_write_cmos_sensor(0xa7,0x95); 
	GC0310MIPI_write_cmos_sensor(0xa9,0xbc); 
	GC0310MIPI_write_cmos_sensor(0xaa,0x95); 
	GC0310MIPI_write_cmos_sensor(0xab,0xab); 
	GC0310MIPI_write_cmos_sensor(0xac,0x8d);
	GC0310MIPI_write_cmos_sensor(0xae,0xc8); 
	GC0310MIPI_write_cmos_sensor(0xaf,0xab); 
	...
	////////////////////////////////////
	GC0310MIPI_write_cmos_sensor(0xfe,0x01);
	GC0310MIPI_write_cmos_sensor(0xd0,0x55);
	GC0310MIPI_write_cmos_sensor(0xd1,0xfa);
	GC0310MIPI_write_cmos_sensor(0xd2,0xfc);
	GC0310MIPI_write_cmos_sensor(0xd3,0xec);
	GC0310MIPI_write_cmos_sensor(0xd4,0x46);
	GC0310MIPI_write_cmos_sensor(0xd5,0xec);
	GC0310MIPI_write_cmos_sensor(0xd6,0x4e);
	GC0310MIPI_write_cmos_sensor(0xd7,0xf3);
	GC0310MIPI_write_cmos_sensor(0xd8,0x07);
	GC0310MIPI_write_cmos_sensor(0xd9,0x08);
	GC0310MIPI_write_cmos_sensor(0xda,0x3c);
	GC0310MIPI_write_cmos_sensor(0xdb,0xd4);
	/////////////////////////////////////////////////
	////////////////////   LSC   ////////////////////
	/////////////////////////////////////////////////
	GC0310MIPI_write_cmos_sensor(0xfe,0x01); 
	...
	GC0310MIPI_write_cmos_sensor(0xc4,0x78); 
	GC0310MIPI_write_cmos_sensor(0xc5,0x58); 
	GC0310MIPI_write_cmos_sensor(0xc6,0x58); 
	GC0310MIPI_write_cmos_sensor(0xc7,0x50); 
	GC0310MIPI_write_cmos_sensor(0xc8,0x30); 
	GC0310MIPI_write_cmos_sensor(0xc9,0x20); 
	...
	GC0310MIPI_write_cmos_sensor(0x08,0x12); //VB
	GC0310MIPI_write_cmos_sensor(0xfe,0x01);
	...
	GC0310MIPI_write_cmos_sensor(0x29,0x02); //25fps
	GC0310MIPI_write_cmos_sensor(0x2a,0x68); 
	GC0310MIPI_write_cmos_sensor(0x2b,0x03); //20fps
	GC0310MIPI_write_cmos_sensor(0x2c,0x02); 
	GC0310MIPI_write_cmos_sensor(0x2d,0x04); //15fps
	GC0310MIPI_write_cmos_sensor(0x2e,0x36);
...
UINT32 GC0310MIPI_get_sensor_id(UINT32 *sensorID)
{
    int  retry = 3; 
 ...
 *
 *************************************************************************/
UINT32 GC0310MIPI_preview(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
...

{
    ...
    GC0310MIPI_write_cmos_sensor(0x93,0x0a); 
    GC0310MIPI_write_cmos_sensor(0x94,0x8a);
    GC0310MIPI_write_cmos_sensor(0x95,0x44); 
    GC0310MIPI_write_cmos_sensor(0x96,0xf0); 
    GC0310MIPI_write_cmos_sensor(0xfe,0x00);
 ...
 *
 *************************************************************************/
UINT32 GC0310MIPI_capture(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
        MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)

{
    ...
    GC0310MIPI_write_cmos_sensor(0xfe,0x00);
    GC0310MIPI_write_cmos_sensor(0x8f,0xaa); 
    GC0310MIPI_write_cmos_sensor(0x90,0x08); 
    GC0310MIPI_write_cmos_sensor(0x91,0x10); 
    GC0310MIPI_write_cmos_sensor(0x92,0x88); 
    GC0310MIPI_write_cmos_sensor(0x93,0x0a); 
    GC0310MIPI_write_cmos_sensor(0x94,0x8a);
    GC0310MIPI_write_cmos_sensor(0x95,0x44); 
    GC0310MIPI_write_cmos_sensor(0x96,0xf0);
...
UINT32 GC0310MIPI_get_resolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
    ...
    return ERROR_NONE;
} /* GC0310MIPI_get_resolution() */


UINT32 GC0310MIPI_get_info(MSDK_SCENARIO_ID_ENUM ScenarioId,
...
UINT32 GC0310MIPI_control(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *pImageWindow,
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    switch (ScenarioId)
    {
    case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
    case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
        SENSORDB("GC0310MIPI_control: camera preview\n");
        GC0310MIPI_capture(pImageWindow, pSensorConfigData);
        break;
    case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
        SENSORDB("GC0310MIPI_control: camera capture\n");
        GC0310MIPI_preview(pImageWindow, pSensorConfigData);
        break;
    }
...
BOOL GC0310MIPI_set_param_wb(UINT16 para)
{
	switch (para)
	{
		...
		case AWB_MODE_CLOUDY_DAYLIGHT:
			...
			GC0310MIPI_write_cmos_sensor(0x77, 0x80); 
			GC0310MIPI_write_cmos_sensor(0x78, 0x40);
			GC0310MIPI_write_cmos_sensor(0x79, 0x48);			
			break;
		
		case AWB_MODE_DAYLIGHT:
			GC0310MIPI_awb_enable(KAL_FALSE);
			GC0310MIPI_write_cmos_sensor(0x77, 0x7a); 
			GC0310MIPI_write_cmos_sensor(0x78, 0x40);
			GC0310MIPI_write_cmos_sensor(0x79, 0x51);					
			break;
		
		case AWB_MODE_INCANDESCENT:
			GC0310MIPI_awb_enable(KAL_FALSE);
			GC0310MIPI_write_cmos_sensor(0x77, 0x44); 
			GC0310MIPI_write_cmos_sensor(0x78, 0x40);
			GC0310MIPI_write_cmos_sensor(0x79, 0xa2);			
			break;
		
		case AWB_MODE_FLUORESCENT:
			GC0310MIPI_awb_enable(KAL_FALSE);
			GC0310MIPI_write_cmos_sensor(0x77, 0x65); 
			GC0310MIPI_write_cmos_sensor(0x78, 0x40);
			GC0310MIPI_write_cmos_sensor(0x79, 0x7f);			
			break;
...
BOOL GC0310MIPI_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			GC0310MIPI_write_cmos_sensor(0xfe,0x00);
			GC0310MIPI_write_cmos_sensor(0x05,0x01);
			GC0310MIPI_write_cmos_sensor(0x06,0x13); //HB
			GC0310MIPI_write_cmos_sensor(0x07,0x00);
			GC0310MIPI_write_cmos_sensor(0x08,0x14); //VB
			GC0310MIPI_write_cmos_sensor(0xfe,0x01);
			GC0310MIPI_write_cmos_sensor(0x25,0x00); //step 
			GC0310MIPI_write_cmos_sensor(0x26,0x81); 

			GC0310MIPI_write_cmos_sensor(0x27,0x02); //30fps
			GC0310MIPI_write_cmos_sensor(0x28,0x04);  
			GC0310MIPI_write_cmos_sensor(0x29,0x02); //25fps
			GC0310MIPI_write_cmos_sensor(0x2a,0x58); 
			GC0310MIPI_write_cmos_sensor(0x2b,0x03); //20fps
			GC0310MIPI_write_cmos_sensor(0x2c,0x06); 
			GC0310MIPI_write_cmos_sensor(0x2d,0x04); //15fps
...
BOOL GC0310MIPI_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		case AE_EV_COMP_n30:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x26);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			break;
		
		case AE_EV_COMP_n20:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x2e);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			break;
		
		case AE_EV_COMP_n10:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x36);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			break;					
		
		case AE_EV_COMP_00:		
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x3e);//35
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			break;
		
		case AE_EV_COMP_10:			
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x46);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			break;
		
		case AE_EV_COMP_20:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x4e);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			break;
		
		case AE_EV_COMP_30:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x56);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			break;
		default:
			return FALSE;
...
UINT32 GC0310MIPI_yuv_set_video_mode(UINT16 u2FrameRate)    // lanking add
{
...
{   
    	switch (para)
    	{
			...
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);	 
			GC0310MIPI_write_cmos_sensor(0xd3, 0x34);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
			Sleep(200);
			break;
        		case ISP_CONTRAST_HIGH:			 
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 	
			GC0310MIPI_write_cmos_sensor(0xd3, 0x64);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			Sleep(200);			
			break;
        		...
        		default:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);	 
			GC0310MIPI_write_cmos_sensor(0xd3, 0x44);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			Sleep(200);			
			break;
    	}
...
BOOL GC0310MIPI_set_edge(UINT16 para)
{
        	switch (para)
        	{
          	case ISP_EDGE_MIDDLE:
                	...
                	case ISP_EDGE_HIGH:
        			GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
        			GC0310MIPI_write_cmos_sensor(0x95, 0x99);
        			GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
               		 break;
                
                	case ISP_EDGE_LOW: 
        			GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
        			GC0310MIPI_write_cmos_sensor(0x95, 0x33);
        			GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
                		break;
...
BOOL GC0310MIPI_set_hue(UINT16 para)
{
        	switch (para)
        	{
          	case ISP_HUE_MIDDLE:
                	...
                	case ISP_HUE_HIGH:
        			GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
        			GC0310MIPI_write_cmos_sensor(0x7a, 0x88); 
        			GC0310MIPI_write_cmos_sensor(0x7b, 0x88); 
        			GC0310MIPI_write_cmos_sensor(0x7c, 0x80); 
        			GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
               		 break;
        			...
        			GC0310MIPI_write_cmos_sensor(0x7a, 0x80); 
        			GC0310MIPI_write_cmos_sensor(0x7b, 0x80); 
        			GC0310MIPI_write_cmos_sensor(0x7c, 0x88); 
        			GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
                		break;
...
void GC0310MIPI_set_saturation(UINT16 para)
{
    	switch (para)
    	{
        		case ISP_SAT_HIGH:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 	
			GC0310MIPI_write_cmos_sensor(0xd1, 0x3b);
			GC0310MIPI_write_cmos_sensor(0xd2, 0x3b);			
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			break;
        		case ISP_SAT_LOW:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 	
			GC0310MIPI_write_cmos_sensor(0xd1, 0x1e);
			GC0310MIPI_write_cmos_sensor(0xd2, 0x1e);	
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			break;
        		case ISP_SAT_MIDDLE:
        		default:
...
void GC0310MIPI_get_delay_info(UINT32 delayAddr)
{
...
UINT32 GC0310MIPI_get_default_framerate_by_scenario(
...
void GC0310MIPI_get_exif_info(UINT32 exifAddr)
{
    ...
    GC0310MIPI_write_cmos_sensor(0xfe,0x01);
    temp_reg3 = GC0310MIPI_read_cmos_sensor(0x26);
    temp_reg4 = GC0310MIPI_read_cmos_sensor(0x25);
    step = (temp_reg3 & 0xFF) | (temp_reg4 << 8);

    shutter_iso = shutter/step*10;

    SENSORDB("GC0310MIPI_get_exif_info shutter=%d,step=%d,shutter_iso=%d\n", shutter, step, shutter_iso);

    if (shutter_iso < 33)
        shutter_iso = 33;

    pExifInfo->CapExposureTime=1000000/shutter_iso;

    GC0310MIPI_write_cmos_sensor(0xfe,0x00);

    t_gain= GC0310MIPI_read_cmos_sensor(0xef);

    SENSORDB("GC0310MIPI_get_exif_info t_gain=%d\n", t_gain);
    ...
    if (t_gain > 0xd0)
        ...
        pExifInfo->RealISOValue = AE_ISO_800;
}

UINT32 GC0310MIPI_yuv_sensor_setting(FEATURE_ID iCmd, UINT16 iPara)
{
	SENSORDB("GC0310MIPI_yuv_sensor_setting iCmd=%d\n", iCmd);
	...
	case FID_ISP_SAT:
		...
		break; 
	case FID_ISP_HUE:
		GC0310MIPI_set_hue(iPara);
		break;
	case FID_ISP_EDGE:
		GC0310MIPI_set_edge(iPara);
		break;
	case FID_AE_ISO:
		GC0310MIPI_set_iso(iPara);
		break;
    	default:
		SENSORDB("GC0310MIPI_yuv_sensor_setting: No corresponding command, iCmd=%d\n", iCmd);
        		break;
	}
    	return TRUE;
} /* GC0310MIPI_yuv_sensor_setting */

UINT32 GC0310MIPI_feature_control(MSDK_SENSOR_FEATURE_ENUM FeatureId,
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    SENSORDB("GC0310MIPI_feature_control FeatureId=%d\n", FeatureId);
    ...
    case SENSOR_FEATURE_SET_NIGHTMODE:
        //GC0310MIPI_night_mode((BOOL) *pFeatureData16);
        break;
    ...
    case SENSOR_FEATURE_SET_YUV_CMD:
        GC0310MIPI_yuv_sensor_setting((FEATURE_ID)*pFeatureData32, *(pFeatureData32+1));
        break;
    case SENSOR_FEATURE_SET_VIDEO_MODE:
        GC0310MIPI_yuv_set_video_mode(*pFeatureData16);
        break;
    case SENSOR_FEATURE_CHECK_SENSOR_ID:
        GC0310MIPI_get_sensor_id(pFeatureData32);
        break;
    case SENSOR_FEATURE_GET_DELAY_INFO:
        GC0310MIPI_get_delay_info(*pFeatureData32);
        break;
    case SENSOR_FEATURE_GET_DEFAULT_FRAME_RATE_BY_SCENARIO:
        GC0310MIPI_get_default_framerate_by_scenario((MSDK_SCENARIO_ID_ENUM)*pFeatureData32, (MUINT32 *)(*(pFeatureData32+1)));
        break;
    case SENSOR_FEATURE_GET_EXIF_INFO:
        GC0310MIPI_get_exif_info(*pFeatureData32);
        break;
    default:
	SENSORDB("GC0310MIPI_feature_control: No corresponding command, FeatureId=%d\n", FeatureId);
        	break;
    }
    return ERROR_NONE;
}	/* GC0310MIPI_feature_control() */
