...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x3002, 0x21); //61
	...
	write_cmos_sensor(0x3508, 0x40); //07
	write_cmos_sensor(0x3509, 0x00); //80
	...
	write_cmos_sensor(0x380d, 0x90); // ;8c
	...
	write_cmos_sensor(0x380f, 0xf6); //; fd  fps fine adjustment
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	write_cmos_sensor(0x3623, 0x00);
	write_cmos_sensor(0x366e, 0x10);
	write_cmos_sensor(0x370b, 0x05);
	write_cmos_sensor(0x3808, 0x07);
	write_cmos_sensor(0x3809, 0x98);
