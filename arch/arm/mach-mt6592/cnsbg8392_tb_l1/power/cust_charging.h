...
#define HIGH_BATTERY_VOLTAGE_SUPPORT//[2015.4/8]johnny add
...
#define MAX_CHARGE_TEMPERATURE  60//johnny[2015.4.22]mody to 60 from 50
...
#define BATTERY_AVERAGE_SIZE 	5//30  //johnny[2015.06.10]desize the average size
