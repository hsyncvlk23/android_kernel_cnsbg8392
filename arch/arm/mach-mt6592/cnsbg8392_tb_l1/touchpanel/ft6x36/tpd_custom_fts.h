...
//#define TPD_POWER_SOURCE_CUSTOM         	MT6322_POWER_LDO_VIBR
...
/*********************Custom Define end*************************************************/
#define TINNO_TOUCH_TRACK_IDS 10 //Tommy
...
#define MT_MAX_TOUCH_POINTS CFG_MAX_TOUCH_POINTS
#define FTS_MAX_ID							0x0F
#define FTS_TOUCH_STEP						6
#define FTS_TOUCH_PRE_OFFSET			2
#define FTS_TOUCH_SIZE_OFFSET			3
...
#define FTS_TOUCH_PRESSURE_H			7
#define FTS_TOUCH_PRESSURE_L			8
#define FTS_TOUCH_WIDTH_H					8
#define FTS_TOUCH_WIDTH_L					9
#define FTS_TOUCH_HEIGHT_H				9
#define FTS_TOUCH_HEIGHT_L				0x0a
