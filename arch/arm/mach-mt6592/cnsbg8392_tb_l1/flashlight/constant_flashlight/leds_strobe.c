...
#define PK_DBG_FUNC(fmt, arg...)    pr_debug( TAG_NAME KERN_INFO  "%s: " fmt, __FUNCTION__ ,##arg)
#define PK_WARN(fmt, arg...)        pr_warn( TAG_NAME KERN_WARNING  "%s: " fmt, __FUNCTION__ ,##arg)
#define PK_NOTICE(fmt, arg...)      pr_debug( TAG_NAME KERN_NOTICE  "%s: " fmt, __FUNCTION__ ,##arg)
#define PK_INFO(fmt, arg...)        pr_info( TAG_NAME KERN_INFO  "%s: " fmt, __FUNCTION__ ,##arg)
#define PK_TRC_FUNC(f)              pr_debug( TAG_NAME "<%s>\n", __FUNCTION__);
#define PK_TRC_VERBOSE(fmt, arg...) pr_debug( TAG_NAME fmt, ##arg)
#define PK_ERROR(fmt, arg...)       pr_err( TAG_NAME KERN_ERR "%s: " fmt, __FUNCTION__ ,##arg)
