...
struct msdc_hw msdc1_hw = {
    ...
    .data_pins      = 4,
    .data_offset    = 0,
#ifdef CONFIG_MTK_MSDC1_NOT_SUPPORT_SDR104
#ifdef CUST_EINT_MSDC1_INS_NUM
    .flags          = MSDC_SYS_SUSPEND | MSDC_WP_PIN_EN | MSDC_CD_PIN_EN | MSDC_REMOVABLE | MSDC_HIGHSPEED | MSDC_UHS1 |
					  MSDC_DDR | MSDC_SD_NOSUPPORT_104 | MSDC_SD_NEED_POWER,
#else
